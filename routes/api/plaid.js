...
const PLAID_CLIENT_ID = '5e4ca3fbfacb020015983185';
const PLAID_SECRET = '09c9e31f29de207640ecd070bd3fec';
const PLAID_PUBLIC_KEY = 'ae73a3cf3798574add046b11f92aba';

const client = new plaid.Client(PLAID_CLIENT_ID, PLAID_SECRET, PLAID_PUBLIC_KEY, plaid.environments.development, {
    version: '2018-05-22',
});
