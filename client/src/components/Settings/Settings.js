...
import { setSpendrLimit } from '../../actions/accountActions';
import { setDateRange } from '../../actions/authActions';
    ...
    return (
        <div
            ...
            <div style={{ marginTop: '25px' }}>
                ...
                <DatePicker onChange={onEndStart} value={endDate} />
            </div>
